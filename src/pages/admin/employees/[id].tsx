...
export default function AdminEmployeeDetailPage() {
  ...
  const [timesheetType, setTimesheetType] = useState("standard");
  ...
  async function loadEmployee() {
    ...
    try {
      ...
      setTimesheetType(String(e.timesheet_type ?? "standard"));
        ...
        <PageHeader
          title={
            <span style={{ display: "inline-flex", gap: 8, alignItems: "center" }}>
              <button onClick={() => router.push("/admin/employees")} className="btn btn-ghost btn-compact">← Back</button>
              <span>{emp ? emp.name : "Employee"}</span>
            </span>
          }
          subtitle="Edit details, then Save."
          actions={
            <>
              <button onClick={loadEmployee} disabled={loading || !empId} className="btn btn-ghost btn-compact">Refresh</button>
              <button onClick={save} disabled={saving || !empId} className="btn btn-primary btn-compact">{saving ? "Saving…" : "Save"}</button>
        ...
        <div className="admin-section-card" style={{ marginTop: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", gap: 12 }}>
            ...
            <div>
              ...
              <div className="subtle" style={{ marginBottom: 6 }}>Select the timesheet layout for this employee.</div>
              <ScrollableDropdown
                value={timesheetType}
                options={[
                ...
                onChange={(next) => setTimesheetType(next)}
              />
            </div>
            <div>
