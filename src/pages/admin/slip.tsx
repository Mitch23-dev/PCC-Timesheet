...
export default function SlipViewer() {
  ...
  if (!path) {
    return <main className="page">Missing slip link.</main>;
  }
    ...
    <main className="page">
      <div className="card">
        ...
        <div className="row" style={{ alignItems: "center", marginTop: 10 }}>
          <button className="btn btn-ghost" onClick={() => setRot((r) => (r - 90 + 360) % 360)}>
            Rotate Left
          </button>
          <button className="btn btn-ghost" onClick={() => setRot((r) => (r + 90) % 360)}>
            Rotate Right
          </button>
